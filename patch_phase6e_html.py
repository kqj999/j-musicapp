#!/usr/bin/env python3
"""
CSS for the currently-open item highlight in the Crate section-box preview.
...
def main():
    ...
    if ".section-box-preview-item.open{" in text:
        print(f"{PATH}: open-item highlight CSS already present — skipping (already patched).")
        return
