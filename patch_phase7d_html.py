#!/usr/bin/env python3
"""
Tiny CSS addition: tints checkboxes (used by Genres' multi-select) to match
the app's green accent instead of default browser styling. Run this from
inside mymusicapp/.
"""
import pathlib
import re
...
def main():
    ...
    if 'input[type="checkbox"]{' in text:
        print(f"{PATH}: checkbox CSS already present — skipping (already patched).")
        return
